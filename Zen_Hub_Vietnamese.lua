...
_G.Settings = {
  Main = {
    ["Tự Động Cày Level"] = false,
    ["Tự Động Cày Level Nhanh"] = false,
    ["Tự Động Cày Xương"] = false,
    ["Tự Động Cày Ectoplasm"] = false,

--[Cày Quái Xung Quanh]
    ["Cày Quái Xung Quanh"] = false,

--[Sea 1]
    ["Tự Động Qua Đảo Mới"] = false,
    ["Tự Động Lấy Saber"] = false,
    ["Tự Động Lấy Lôi Gậy V1"] = false,
    ["Tự Động Mua Kĩ Năng"] = false,

--[Sea 2]
    ["Tự Động Qua Sea 3"] = false,
    ["Tự Động Đánh Factory"] = false,
    ["Tự Động Đánh Factory(Hop Server)"] = false,
    ["Tự Động Làm Nhiệm Vụ Bartilo"] = false,

    ["Tự Động Lấy Tam Bảo Kiếm"] = false,
    ["Tự Động Lấy Rengoku"] = false,
    ["Tự Động Lấy Kính Swan"] = false,
    ["Tự Động Lấy Áo Choàng Bóng Tối"] = false,

    ["Tự Động Mua Kiếm Huyền Thoại"] = false,
    ["Tự Động Mua Haki Màu"] = false,

--[Sea 3]
    ["Tự Động Thắp Đuốc"] = false,
    ["Tự Động Lấy Kiếm Buddy"] = false,
    ["Tự Động Đánh Boss Sứ Giả Bóng Tối"] = false,
    ["Tự Động Lấy Haki Cầu Vòng"] = false,
    ["Tự Động Đánh Elite"] = false,
    ["Tự Động Lấy Mũ Musketeer"] = false,
    ["Tự Động Lấy Kiếm Buddy"] = false,
    ["Tự Động Lấy Quan Sát V2"] = false,
    ["Tự Động Lấy Kiếm Cavander"] = false,
    ["Tự Động Lấy Kiếm Yama"] = false,
    ["Tự Động Lấy Kiếm Tushita"] = false,
    ["Tự Động Lấy Cung Mãng Xà"] = false,
    ["Tự Động Lấy Dao Găm Bóng Tối"] = false,
    ["Tự Động Đánh Katakuri V1"] = false,
    ["Tự Động Đánh Katakuri V2"] = false,
    ["Tự Động Cày Xương"] = false,

--[Lấy God Human]

    ["Tự Động Cày Đuôi Cá (Sea 1)"] = false,
    ["Tự Động Cày Đuôi Cá (Sea 3)"] = false,
    ["Tự Động Cày Quặng Dung Nham (Sea 2)"] = false,
    ["Tự Động Cày Quặng Dung Nham (Sea 1)"] = false,
    ["Tự Động Cày Nước Mắt Biển Cả"] = false,
    ["Tự Động Cày Vảy Rồng"] = false,

  },
  Vũ Khí Cận Chiến = {
    ["Tự Động Lấy God Human"] = false,
    ["Tự Động Lấy Superhuman"] = false,
    ["Tự Động Lấy Lôi Trảo"] = false,
    ["Tự Động Lấy Tử Cước"] = false,
    ["Auto Fully Death Step"] = false,
    ["Tự Động Lấy Võ Cá Mập"] = false,
    ["Auto Fully SharkMan Karate"] = false,
    ["Tự Động Lấy Long Trảo"] = false,
  },
  Boss = {
    ["Tự Động Cày Tất Cả Boss"] = false,
    ["Cày Boss Đã Chọn"] = false,
    ["Chọn Boss"] = {},
    ["Tự Động Nhận Nhiệm Vụ"] = false,
  },
  Thông Thạo = {
    ["Chọn Kiếm"] = {},
    ["Cày Thông Thạo Kiếm"] = false,
    ["Tự Động Cày Thông Thạo Trái Blox"] = false,
    ["Tự Động Cày Thông Thạo Súng"] = false,
    ["Mob Health (%)"] = 15,
  },
  Configs = {
    ["Nhận Hai Nhiệm Vụ"] = false,
    ["Bypass TP"] = false,
    ["Chọn Đội"] = {
      "Hải Tặc"
    }, --{Hải Tặc,Hải Quân}
...
--[Mob Configs]
    ["Xem Hitbox"] = false,
    ["Gom Quái"] = true,
    ["Tắt Sát Thương"] = false,

  },
  Stat = {
--[Tự Động Nâng Stats]
    ["Bật Tự Động Nâng Stats"] = false,
    ["Tự Động Nâng Stats Kaitun"] = false,

    ["Chọn Stats"] = {
      "Cận Chiến"
    }, --{Tối Đa Stats,Cận Chiến,Phòng Thủ,Kiếm,Trái Blox,Súng}
    ["Chọn Điểm"] = 3, --{Khuyến nghị , Tối Đa : 9}

--[Tự Động Random Mã]

    ["Bật Tự Động Redeem Mã"] = false,
    ["Chọn Level Redeem Code"] = 1, --{Tối Đa : 2550}
  },

  Misc = {
    ["Tốc Biến Vô Hạn"] = false,
    ["Lướt Vô Hạn"] = false,

    ["Vô Hạn Geppo"] = false,
    ["Vô Hạn Năng Lượng "] = false,
...
--[Máy chủ]
    ["Tự Động Vào Lại"] = true,
  },
  Dịch Chuyển = {
    ["Dịch Chuyển Đến Thủy Quái"] = false,
  },

  Raids = {
    ["Tự Động Raids"] = false,

    ["Đánh Quái Xung Quanh"] = false,
    ["Tự Động Thức Tỉnh Trái Blox"] = false,
    ["Tự Động Qua Đảo Mới"] = false,

    ["Chọn Trái Blox Raids"] = {}, -- {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough"},
  },

  Combat = {
    ["Kích cỡ Fov"] = 200,
    ["Xem Fov"] = false,
    ["Kĩ Năng Aimbot"] = false,
  },

  HUD = {
    ["FPS"] = 60,
    ["Khóa FPS"] = true,
    ["Tăng Tốc FPS Windows"] = false,
    ['Màn Hình Trắng'] = false,
  }
}
...
_G.ShowItem = {
  ...
  ["Kiểm Tra Vũ Khí Cận Chiến"] = {
    ["Bật Để Kiểm Tra"] = true,
  },
  ["Kiểm Tra Trái Blox Thức Tỉnh"] = {
    ["Bật Để Kiểm Tra"] = true,
  },
  ["Kiểm Tra Trái Blox"] = {
    ["Bật Để Kiểm Tra"] = true,
...
-- [Giao Diện Thiệt Hại Bị Vô Hiệu Hóa ]
...
-- [Chức Năng (Nhiệm Vụ Bị Bỏ Rơi, Khác) ]
